...
.. note::
  ...
  Any changes to the JMESPath specification  must have a JEP (JMESPath Enhancement Proposal)
  which is `tracked in a corresponding repository <https://github.com/jmespath-unofficial/jmespath.spec/>`__.
...
.. literalinclude:: grammar/jmespath-grammar.txt
...
2. A ``pipe-expression`` **stops projections on the left hand side from
...
.. include:: grammar/functions/abs.inc
.. include:: grammar/functions/avg.inc
.. include:: grammar/functions/ceil.inc
...
.. include:: grammar/functions/map.inc
.. include:: grammar/functions/max-by.inc
.. include:: grammar/functions/max.inc
...
.. include:: grammar/functions/starts-with.inc
.. include:: grammar/functions/sum.inc
.. include:: grammar/functions/to-array.inc
.. include:: grammar/functions/to-number.inc
