---
title: "pad_left"
description: "Given the subject string, pad_left() adds characters to the beginning and returns a string of length at least width."
topic: "strings"
signature: "pad_left(subject: string, width: number, pad?: string) -> string"
version: "latest"
---
